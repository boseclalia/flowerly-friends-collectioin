...
var _chunkIAXENOFXcjs = require('./chunk-IAXENOFX.cjs');
...
var _snowflakeid = require('@skorotkiewicz/snowflake-id');
var snowflake = new (0, _snowflakeid.Snowflake)(42 * 10);
...
var initRecording = async (page2, onBrowserEvent) => {
  page2.addInitScript(() => {
    ...
    function handleKeyDown(event) {
      ...
      if (_optionalChain([document, 'access', _2 => _2.activeElement, 'optionalAccess', _3 => _3.tagName, 'access', _4 => _4.toLowerCase, 'call', _5 => _5()]) === "input") {
        if (event.key === "Tab") {
          window.recordKeyPress(dom, [event.key]);
        }
        return;
      }
      if (_optionalChain([document, 'access', _6 => _6.activeElement, 'optionalAccess', _7 => _7.tagName, 'access', _8 => _8.toLowerCase, 'call', _9 => _9()]) === "textarea") {
        return;
      }
      const keys = [];
    ...
    function handleKeyUp(event) {
      ...
      if (_optionalChain([document, 'access', _10 => _10.activeElement, 'optionalAccess', _11 => _11.tagName, 'access', _12 => _12.toLowerCase, 'call', _13 => _13()]) !== "input" && _optionalChain([document, 'access', _14 => _14.activeElement, 'optionalAccess', _15 => _15.tagName, 'access', _16 => _16.toLowerCase, 'call', _17 => _17()]) !== "textarea") {
        return;
      }
      const dom = getDom();
      window.recordInput(
...
var parseDom = (html) => {
  const window2 = new (0, _happydom.Window)({
    settings: {
...
var extractText = (element) => {
  if (element.childNodes.length === 0) {
    return _optionalChain([element, 'access', _18 => _18.textContent, 'optionalAccess', _19 => _19.trim, 'call', _20 => _20()]) || "";
  }
...
var extractTextsFromSiblings = (element) => {
  const siblings = Array.from(_optionalChain([element, 'access', _21 => _21.parentElement, 'optionalAccess', _22 => _22.childNodes]) || []);
...
var getElementName = (element) => {
  ...
  for (const attr of priorityAttrs) {
    if (!text) {
      text = _optionalChain([element, 'optionalAccess', _23 => _23.getAttribute, 'call', _24 => _24(attr)]) || "";
    }
  }
  if (!text) {
...
var getElementType = (element) => {
  const tagName = _optionalChain([element, 'optionalAccess', _25 => _25.tagName, 'access', _26 => _26.toLowerCase, 'call', _27 => _27()]);
...
var handleBrowserEvent = (page2) => {
  const eventQueue = [];
  const processEvents = _lodash2.default.debounce(() => {
...
server.tool(
  ...
  async ({ url: url2 }) => {
    ...
    await page.addInitScript(_chunkIAXENOFXcjs.injectToolbox);
